...
I replaced the brass spacer I made for [session 2](https://kem406.github.io/PHYS-S12/06/) with the 3D printed version, since I would prefer the spacer to be precisely even, which is hard to achieve by filing a brass spacer down, and machining a perfect spacer with a mill would be time consuming (in contrast, the 3D printer made what I needed in a few minutes!).
