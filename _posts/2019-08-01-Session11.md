...
I then cut three identical t-shaped bars using an endmill and deburred them with a grinder. By a center hole in one of these, I was able to finish my clamp for the pneumatic cylinder by drilling a smaller and tapped hole in the U-shaped piece:
