...
<img src="clamp1.png" alt="Clamp 1 CAD" style="height: 200px; max-width: 48%">

<img src="clamp2.png" alt="Clamp 2 CAD" style="height: 200px; max-width: 48%">

Stopper:

<img src="stopper.png" alt="Stopper CAD" style="height: 200px; max-width: 48%">

Spacer:

<img src="spacer.png" alt="Spacer CAD" style="height: 200px; max-width: 48%">
...
Oddly enough, despite the fact that the levitating globe rotated on its own, the 3D scanner could not seem to recognize the fact that it was spinning and so only imaged a hollow hemisphere. I tried placing a square object on top of the globe to see if this was an issue with the sphere shape itself, but this didn't fix it either. So I simply walked around the globe myself and captured every angle I could. This did the trick, since the 3D scanner was able to tell from the background moving that I was walking to the backside of the globe.

<img src="sphere.png" alt="Sphere" style="height: 200px; max-width: 48%">

Here is the model (.stl can be download [here](https://kem406.github.io/PHYS-S12/06/sphere.stl)\) created by the 3D scanner:
