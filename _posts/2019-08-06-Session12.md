...
### Testing the McKibben Actuators
...
The air cylinder holder is screwed to the air cylinder, and is connected to the bracket I machined earlier. The bracket can slide up and down the track, and can be clamped in place once the desired location is found. This allows for flexibility and eliminates the need to drill holes.
...
<img src="pivot.jpg" alt="Pivot" style="height: 200px; max-width: 48%">
...
<img src="spring.jpg" alt="Spring" style="height: 200px; max-width: 48%">

### Circuit Design and Controls

As mentioned earlier, the robot's movement is powered by an air tank.

<img src="tank.jpg" alt="Tank" style="height: 200px; max-width: 48%">

Flow from the air tank into each joing is controlled by air valves, which are in turn controlled by an Arduino Nano and some pushbuttons.

<img src="controls.jpg" alt="Controls" style="height: 200px; max-width: 48%">

The buttons on the right pump air into the actuators, while the ones on the left are pressure release valves:

<img src="breadboards.jpg" alt="Breadboards" style="height: 200px; max-width: 48%">
