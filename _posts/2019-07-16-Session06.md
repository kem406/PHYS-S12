...
<img src="connector.png" alt="Connector 1" style="height: 200px; max-width: 48%">
...
<img src="3dprint.png" alt="3D Printer" style="height: 200px; max-width: 48%">
...
<img src="mold1.png" alt="Mold 1" style="height: 200px; max-width: 48%">
...
<img src="molds.png" alt="Molds" style="height: 200px; max-width: 48%">
...
<img src="foot.png" alt="Mold 2 in Fusion 360" style="height: 200px; max-width: 48%">

<img src="mold2.png" alt="Mold 2" style="height: 200px; max-width: 48%">

While 3D printing the air-hose connector was done more in the interest of time than anything else, I think a good case can be made for 3D printing the molds specifically because I need the mold to be as precise as possible, and I don't think making one out of cardboard would cut it.
