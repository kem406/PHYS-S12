...
Rather than spending the three dollars needed to buy one of these connectors, I decided to try 3D print my own by designing it in Fusion 360 (.stl file can be found [here](My STL file can be downloaded [here](https://kem406.github.io/PHYS-S12/06/triconnector1.stl)\):
